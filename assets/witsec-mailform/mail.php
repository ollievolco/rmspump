...
$to = "lmcquaw@rmspump.com";														// To Address
$toAlt = "";												// Additional Recipients
$from = "server@stage4000.com";													// From Address
$fromName = "Stage4000 Web Services - Administrator";											// From Name
...
$template = "Hi,<br><br>You have received a new message from your website.<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Powered by stage4000, Inc.";											// Mail Template
$autorespondSubjectPrefix = "Re:";			// Autorespond Form Subject Prefix
$autorespondSubject = "RMS Pump - Website Contact Form Submission.";						// Autorespond Custom Subject
$autorespondTemplate = "Hi {name},<br><br>Thank you for your message. We'll get back to you as soon as we can.<br>Here's the information you sent us:<br><br>Date: {date}<br>{formdata}<br><br>---<br>Have a nice day.";					// Autorespond Template
